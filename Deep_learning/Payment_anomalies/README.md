...
This project detects fraudulent credit card transactions using an **autoencoder-based deep learning model**.  
The model learns normal transaction patterns and flags anomalies as potential frauds.
