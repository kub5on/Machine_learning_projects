...
This project detects fraudulent credit card transactions using an **autoencoder-based deep learning model**. The model learns normal transaction patterns and flags anomalies as potential frauds.
...
- **Evaluation Metrics:** ROC AUC score, classification report, and confusion matrix.
