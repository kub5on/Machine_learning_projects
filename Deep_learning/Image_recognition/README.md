...
This project classifies images from the Fashion MNIST dataset into 10 categories using **Convolutional Neural Networks (CNN)**. It also includes **hyperparameter tuning** to optimize the CNN architecture and training parameters using _Keras Tuner_.
